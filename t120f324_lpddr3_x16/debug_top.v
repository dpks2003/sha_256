...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  [255:0] vio0_rdata_exp0,
    input  [255:0] vio0_rdata_det0,
    input  [255:0] vio0_rdata_exp1,
    input  [255:0] vio0_rdata_det1,
    input  [3:0] vio0_axi0_states,
    input  [3:0] vio0_axi1_states,
    output vio0_check_rstn,
    output vio0_pll_rstni
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 6 ),
        .NUM_PROBE_OUT          ( 2 ),
        .UUID           ( 128'h8b68408d11044b00a50999d12eecc5e0 ),
        .PROBE_IN0_WIDTH        ( 256 ),
        .PROBE_IN1_WIDTH        ( 256 ),
        .PROBE_IN2_WIDTH        ( 256 ),
        .PROBE_IN3_WIDTH        ( 256 ),
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_rdata_exp0 ),
        .probe_in1          ( vio0_rdata_det0 ),
        .probe_in2          ( vio0_rdata_exp1 ),
        .probe_in3          ( vio0_rdata_det1 ),
        .probe_in4          ( vio0_axi0_states ),
        .probe_in5          ( vio0_axi1_states ),
        .probe_in6          ( 1'b0 ),
        .probe_in7          ( 1'b0 ),
        .probe_in8          ( 1'b0 ),
        .probe_in9          ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_check_rstn ),
        .probe_out1         ( vio0_pll_rstni ),
        .probe_out2         (  ),
        .probe_out3         (  ),
        .probe_out4         (  ),
        .probe_out5         (  ),
